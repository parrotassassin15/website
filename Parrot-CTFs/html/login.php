...
<html>
   <head>
      ...
      <title>Parrot CTFs | Login</title>
      <meta name="description" content="Parrot CTFs - A CTF platform for all fields of IT - Login">
   ...
   <body>
         ...
         <nav class="navbar navbar-expand-lg py-3 bg-dash-dark-2 border-bottom border-dash-dark-1 z-index-10">
            ...
            <div class="container-fluid d-flex align-items-center justify-content-between py-1">
               ...
               <ul class="list-inline mb-0">
                  ...
                  <li class="list-inline-item merch px-lg-2">                 <a class="nav-link text-sm text-reset px-1 px-lg-0" href="/signup.php"> <span class="d-none d-sm-inline-block">Signup</span>
               ...
               <div class="card-body pt-0">
                  ...
                  <form class="form-horizontal" method='post' action='/api/login.php'>
                     <div class="row gy-2 mb-4">
                        ...
                        <div class="col-sm-5">
                           <input class="form-control" id="inputHorizontalElOne" name = 'email' type="text" placeholder="Email/Username">
                        </div>
                     </div>
                     <div class="row gy-2 mb-4">
                        <label class="col-sm-3 form-label" for="inputHorizontalElTwo">Password</label>
                        <div class="col-sm-5">
                           <input class="form-control" id="inputHorizontalElTwo" name = 'password' type="password" placeholder="Pasword">
                        </div>
                     </div>
                     <div class="row">
                        <div class="col-sm-9 ms-auto">
                           <input class="btn btn-primary" type="submit" value="Login" style="margin-right: 100%; ">
      </center>
      </div>
      </div>
      </form>
      ...
      <!-- Page Footer-->
      <audio src="/music/audio-login.mp3"  autoplay loop></audio>
      </div>
      </div>
      <!-- JavaScript files-->
